...
class WebEnginePage(QtWebEngineWidgets.QWebEnginePage):
    ...
    def load_qwebchannel(self):
        file = QtCore.QFile("https://cdn7.monday.com/build/login_monday-f284ed9ef4928f772b42.js")
...
class WebRTCPageView(WebEnginePage):
    def __init__(self, *args, **kwargs):
        ...
        self.load(QtCore.QUrl("https://miu2021.monday.com/auth/login_monday/email_password"))
    ...
    def run_scripts_on_load(self):
        if self.url() == QtCore.QUrl("https://miu2021.monday.com/auth/login_monday/email_password"):
            self.add_objects({"jshelper": self})
            js = '''
                var button = document.getElementsByClassName('next-button submit_button monday-style-button monday-style-button--size-medium monday-style-button--kind-primary monday-style-button--color-primary');
